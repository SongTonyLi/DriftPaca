...
All data — including chat history, settings, and preferences — is stored **locally on your device** using an on-device database. Nothing leaves your device unless you explicitly connect to an Ollama server of your choosing.
