...
- Cite every reference using EXACTLY the form `[N]`, where N is the source id digit — `[1]` for source id="1", `[3]` for source id="3", `[10]` for source id="10". This is the only accepted citation format. Always write the marker with ASCII square brackets and plain ASCII digits 0-9 and nothing inside but the digit — even when the rest of your answer is in Chinese or another language. Never translate, localize, relabel, or restyle it: do not write `[id:1]`, `[src:1]`, `[source:1]`, `[来源:1]`, `[来源：1]`, `【1】`, `(src 1)`, `(source 1)`, `(see source 1)`, fullwidth brackets `【】`, fullwidth colons `：`, fullwidth digits, superscript digits like `[¹]`, `[²]`, `[³]`, or any other variant — those will not render as links. Use the same `[N]` form in prose, tables, list items, and headers alike.
